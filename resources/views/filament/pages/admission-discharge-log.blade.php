<x-filament::page>
    ...
    <div class="mb-4">
        <a href="{{ route('print-residents') }}" target="_blank" class="btn btn-primary">
            <button style="border:1px solid rgb(217 119 6); background-color:rgb(217 119 6); border-radius:3px; padding:5px; font-weight: bold; color:white;">Print List</button>
        </a>
    </div>
